...
class RolController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
       ...
       if($rol->save()){
        ...
        return Redirect::to('administracion/roles')->with('mensaje-error', 'No se pudo Actualizar');
                    ...
                    ->addColumn('accion', function($row){
                        ...
                        $url = route('roles.edit',['parameters' => $row->id]);
                           ...
                           $btn = '<a title="Editar" style="cursor:pointer;" href="'.$url. '" role="button"><i class="fa fa-edit"></i></a>
                            <a title="Eliminar" style="cursor:pointer;"   onclick="eliminar_rol('.$row->id.')" class="btn-delete" role="button"><i class="fa fa-trash"></i></a>';
